package kr.toxicity.animator.nms.v1_20_R1
...
class DisplayRendererImpl(private val nmsImpl: NMSImpl): IRenderer {
    private class PlayerBoneData(val limb: PlayerBone) {
        ...
        fun updateLocation() {
            ...
            display.moveTo(loc.x, loc.y + display.myRidingOffset, loc.z, limb.model.baseYaw, 0F)
        }
    ...
    private fun getMovePackets(): List<Packet<*>> {
        ...
        return listOf(
            ClientboundTeleportEntityPacket(data.cloud),
